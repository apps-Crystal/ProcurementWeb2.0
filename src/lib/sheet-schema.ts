...
export const SHEET_SCHEMA = {
    ...
    MPR: [
        ...
        "RETENTION_AMOUNT", "PAYMENT_LINKED_TO_MILESTONE", "LATE_DELIVERY_LD_PCT", "LATE_DELIVERY_LD_MAX_PCT",
        "QUALITY_STANDARD", "WARRANTY_MONTHS", "TEST_CERT_REQUIRED", "SPECIAL_COMMERCIAL_TERMS",
    ...
    SPR: [
        ...
        "PAYMENT_TERMS", "CONTRACT_START_DATE", "CONTRACT_END_DATE", "AMC_VALUE",
        "AMC_SCOPE", "RENEWAL_ALERT_SENT", "PROJECT_CODE", "MILESTONE_TAGS",
        "PAYMENT_LINKED_TO_MILESTONES", "CONSULTANT_NAME", "ENGAGEMENT_TYPE", "SAC_CODE",
        "TDS_APPLICABLE", "TDS_SECTION", "QUANTITY", "RATE",
        "GST_PERCENT", "TOTAL_AMOUNT_BEFORE_GST", "TOTAL_GST_AMOUNT", "TOTAL_AMOUNT_WITH_GST",
        "QUOTATION_URL", "PROFORMA_INVOICE_URL", "SCOPE_DOC_URL", "STATUS",
        "ASSIGNED_APPROVER_ID", "ASSIGNED_APPROVER_NAME", "APPROVER_ACTION_DATE", "APPROVER_REMARKS",
        "SUBMITTED_DATE", "LAST_UPDATED_BY", "LAST_UPDATED_DATE",
    ],
    ...
    PO: [
        ...
        "ADVANCE_PAYMENT_PCT", "ADVANCE_AMOUNT", "PAYMENT_SCHEDULE", "SUBTOTAL",
        "TOTAL_GST",
    ...
    // ── INVOICES ───────────────────────────────────────────────────────────────
    INVOICES: [
        "INVOICE_ID", "INVOICE_DATE", "VENDOR_INVOICE_NUMBER", "VENDOR_INVOICE_DATE",
        ...
        "TAXABLE_AMOUNT", "GST_AMOUNT", "TDS_AMOUNT", "TOTAL_INVOICE_AMOUNT",
    ...
    // ── INVOICE LINES ──────────────────────────────────────────────────────────
    INVOICE_LINES: [
        "INVOICE_LINE_ID", "INVOICE_ID", "LINE_NUMBER", "ITEM_DESCRIPTION",
        "HSN_SAC_CODE", "QUANTITY", "RATE", "TAXABLE_AMOUNT",
    ...
    PAYMENTS: [
        ...
        "ADVANCE_DEDUCTION",
        "CREDIT_NOTE_DEDUCTION", "DEBIT_NOTE_DEDUCTION", "TDS_DEDUCTION", "NET_PAYABLE",
        "PAYMENT_MODE", "BANK_ACCOUNT_NUMBER", "IFSC_CODE", "UTR_NUMBER",
        "PAYMENT_VOUCHER_NUMBER", "PAYMENT_ADVICE_PDF_URL", "STATUS", "HOLD_REASON",
        "IS_PREPAID", "IS_FINAL_PAYMENT", "CREATED_BY", "CREATED_DATE",
        "LAST_UPDATED_BY", "LAST_UPDATED_DATE", "REMARKS",
    ],
